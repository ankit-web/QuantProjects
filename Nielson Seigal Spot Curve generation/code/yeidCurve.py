...
def main():
    ...
    logging.info("NS_paramters.csv file generated sucessfully")
    output_NS.to_csv(params.FileOutpath.value+"NS_predicted_spot.csv")
    logging.info("NS_predicted_spot.csvfile generated sucessfully")
    statsOutput.to_csv(params.FileOutpath.value + "/NSActualPreredictedStatsComp.csv")
    logging.info("NSActualPreredictedStatsComp.csv generated sucessfully")
